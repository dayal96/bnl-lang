 ...
 *
 * A Function Expression when evaluated closes on the environment it was defined in.
 * In other words, the context of a function is determined by it's definition and not invocation.
 * So if a function is defined in one scope but invoked from a different scope, it remembers the
 * environment it was defined in and uses that for lookups.
 */
